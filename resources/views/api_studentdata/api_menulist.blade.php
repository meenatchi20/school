...
<body>
		...
		<script>
				...
				document.addEventListener('DOMContentLoaded',function(){
					...
					httpRequest.open('GET','http://127.0.0.1:8000/api/list/menu',true);
					...
					httpRequest.onload = function(){
						...
						responseData.forEach(data => {
							...
							row.innerHTML += `
								...
								<td>
								<div class="editDel">
								<a href="editmenu/${data.id}" id="update"><i class='fa-solid fa-pencil' ></i></a>
		  	...
		  	function deleteMenuData(id){
		  			...
		  			deleteRequest.open('DELETE',`http://127.0.0.1:8000/api/delete/menu/${id}`,true)
		            ...
		            deleteRequest.onload = function(){
		            	if(deleteRequest.status === 200){		            		
		            		alert("MenuData Deleted Sucessfully");
